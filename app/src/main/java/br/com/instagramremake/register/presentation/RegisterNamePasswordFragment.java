...
public class RegisterNamePasswordFragment extends AbstractFragment<RegisterPresenter> implements RegisterView.NamePasswordView {
    ...
    public void onButtonNextClick() {
        presenter.setNameAndPassword(editTextName.getText().toString(), editTextPassword.getText().toString(), editTextConfirm.getText().toString());
    }
    ...
    public void onTextChanged(CharSequence s) {
        buttonNext.setEnabled(!editTextName.getText().toString().isEmpty() && !editTextPassword.getText().toString().isEmpty() && !editTextConfirm.getText().toString().isEmpty());
